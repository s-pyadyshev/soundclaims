 ...
 */
export function replaceNativeSelect(select, renderer) {
 ...
 * @param {function} [renderer] An optional custom item label renderer.
 */
export function updateFromNativeSelect(select, renderer) {
  const options = select.children;
  const parentNode = select.parentNode;
...
export default {
  init,
  replace: replaceNativeSelect,
  update: updateFromNativeSelect
};